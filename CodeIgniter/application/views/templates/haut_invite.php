            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="<?php echo $this->config->base_url(); ?>index.php/presentationInvites/getInfos">Profil</a></li>
                        <!-- <li class="nav-item"><a class="nav-link"> truc2 </a></li> -->
