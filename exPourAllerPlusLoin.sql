...
# Procedure qui supprime une animation
DROP PROCEDURE IF EXISTS delete_ani; 

DELIMITER //
CREATE PROCEDURE delete_ani(in animation_id INT)
BEGIN	
	DELETE FROM t_intervention_int WHERE ani_id = animation_id;
	DELETE FROM t_animation_ani WHERE ani_id = animation_id;
END;
//
DELIMITER ;
